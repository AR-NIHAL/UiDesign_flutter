...
class StandardBottomNavDemo extends StatefulWidget {
  const StandardBottomNavDemo({super.key});

  @override
  State<StandardBottomNavDemo> createState() => _StandardBottomNavDemoState();
}

class _StandardBottomNavDemoState extends State<StandardBottomNavDemo> {
  int _currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Standard BottomNavigationBar')),
